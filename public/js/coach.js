...
angular
  ...
  .controller("MainController", [
    ...
    function($scope) {
      $scope.options = {
        defaultDate: "2019-02-06",
        minDate: "2018-01-01",
        maxDate: "2020-12-31",
        disabledDates: ["2019-02-22", "2019-03-27", "2019-04-11", "2019-04-15"],
      ...
      $scope.events = [
        { foo: "bar", date: "2019-02-18" },
        { foo: "bar", date: "2019-08-20" }
      ];
    }
  ]);
  ...
  function t(e, t) {
    ...
    function i(t) {
      ...
      return e.options.minDate && a < e.options.minDate
        ? !1
        : e.options.maxDate && a > e.options.maxDate ? !1 : !0;
    }
    function d(t) {
